    ...
    struct JsonProtocol
    {
        ...
        public:
            ...
            static  rapidjson::Value   writeJson(rapidjson::Document& doc, const map<string, string>& value)
            {
                ...
                {
                    mapObject.AddMember(rapidjson::GenericValue<rapidjson::UTF8<>>(it->first.c_str(), doc.GetAllocator()), rapidjson::Value(it->second.c_str(), doc.GetAllocator()), doc.GetAllocator());
                }
                return mapObject;
            }
            ...
            static  rapidjson::Value   writeJson(rapidjson::Document& doc, const map<int, string>& value)
            {
                ...
                {
                    mapObject.AddMember(rapidjson::GenericValue<rapidjson::UTF8<>>(std::to_string((*it).first).c_str(), doc.GetAllocator()), rapidjson::Value(it->second.c_str(), doc.GetAllocator()), doc.GetAllocator());
                }
                return mapObject;
            }
            ...
            static  rapidjson::Value   writeJson(rapidjson::Document& doc, const map<string, int>& value)
            {
                ...
                {
                    mapObject.AddMember(rapidjson::GenericValue<rapidjson::UTF8<>>(it->first.c_str(), doc.GetAllocator()), rapidjson::Value(it->second), doc.GetAllocator());
                }
                return mapObject;
            }
            ...
            static  rapidjson::Value   writeJson(rapidjson::Document& doc, const map<int, V>& value)
            {
                ...
                for (map<int, V>::const_iterator it = value.begin(); it != value.end(); ++it)
                {
                    ...
                    mapObject.AddMember(rapidjson::GenericValue<rapidjson::UTF8<>>(std::to_string(it->first).c_str(), doc.GetAllocator()), writeJson(doc, it->second), doc.GetAllocator());
                }
            ...
            struct TupleWriter {
                static void write(rapidjson::Document& doc, rapidjson::Value& mapObject, const Tuple& t)
                {
                    ...
                    mapObject.AddMember(rapidjson::GenericValue<rapidjson::UTF8<>>(std::to_string(N - 1).c_str(), doc.GetAllocator()), writeJson(doc, std::get<N - 1>(t)), doc.GetAllocator());
                }
            };
            ...
            struct TupleWriter < Tuple, 1 > {
                static void write(rapidjson::Document& doc, rapidjson::Value& mapObject, const Tuple& t)
                {
                    mapObject.AddMember(rapidjson::GenericValue<rapidjson::UTF8<>>(std::to_string(0).c_str(), doc.GetAllocator()), writeJson(doc, std::get<0>(t)), doc.GetAllocator());
                }
            };
        ...
        public:
            ...
            string    call(FunctionMgr& jsonFunctionResponseMgr, const char* funname, const Args&... args)
            {
                ...
                msg.AddMember(rapidjson::GenericValue<rapidjson::UTF8<>>("name", mDoc.GetAllocator()), rapidjson::Value(funname, mDoc.GetAllocator()), mDoc.GetAllocator());
                int index = 0;
                ...
                msg.AddMember(rapidjson::GenericValue<rapidjson::UTF8<>>("req_id", mDoc.GetAllocator()), rapidjson::Value(old_req_id == now_req_id ? -1 : now_req_id), mDoc.GetAllocator());
